...
par(mfrow=c(2,2))
plot(feb2$DateTime, feb2$Global_active_power,type="l", xlab = "", ylab = "Global Active Power")
plot(feb2$DateTime, feb2$Voltage, type="l", xlab="datetime",ylab="Voltage")
plot(feb2$DateTime, feb2$Sub_metering_1, type="l", xlab = "", ylab="Energy sub metering")
lines(feb2$DateTime, feb2$Sub_metering_2, col="#ff0000")
lines(feb2$DateTime, feb2$Sub_metering_3, col="#0000ff")
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),bty="n",col=c("black","red","blue"),
       lwd=c(1,1,1))
plot(feb2$DateTime, feb2$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
